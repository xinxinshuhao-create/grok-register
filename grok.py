...
def main():
    ...
    parser.add_argument("--email-provider", choices=["gptmail", "luckmail", "mailtm", "gmail", "tmail", "fce"], default=os.getenv("EMAIL_PROVIDER", "luckmail"), help="邮箱提供商：gptmail/luckmail/mailtm/gmail/tmail/fce")
